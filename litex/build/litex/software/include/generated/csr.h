//--------------------------------------------------------------------------------
// Auto-generated by LiteX (bf081324) on 2023-11-24 13:57:09
//--------------------------------------------------------------------------------
...
#define CSR_APF_BRIDGE_SLOT_ID_ADDR (CSR_BASE + 0x804L)
...
#define CSR_APF_BRIDGE_DATA_OFFSET_ADDR (CSR_BASE + 0x808L)
...
#define CSR_APF_BRIDGE_TRANSFER_LENGTH_ADDR (CSR_BASE + 0x80cL)
...
#define CSR_APF_BRIDGE_RAM_DATA_ADDRESS_ADDR (CSR_BASE + 0x810L)
...
#define CSR_APF_BRIDGE_FILE_SIZE_ADDR (CSR_BASE + 0x814L)
...
#define CSR_APF_BRIDGE_STATUS_ADDR (CSR_BASE + 0x818L)
...
#define CSR_APF_BRIDGE_CURRENT_ADDRESS_ADDR (CSR_BASE + 0x81cL)
...
/* apf_rtc */
#define CSR_APF_RTC_BASE (CSR_BASE + 0x2000L)
#define CSR_APF_RTC_UNIX_SECONDS_ADDR (CSR_BASE + 0x2000L)
#define CSR_APF_RTC_UNIX_SECONDS_SIZE 1
static inline uint32_t apf_rtc_unix_seconds_read(void) {
	return csr_read_simple((CSR_BASE + 0x2000L));
}
#define CSR_APF_RTC_DATE_BCD_ADDR (CSR_BASE + 0x2004L)
...
#define CSR_APF_RTC_TIME_BCD_ADDR (CSR_BASE + 0x2008L)
...
/* apf_video */
#define CSR_APF_VIDEO_BASE (CSR_BASE + 0x2800L)
#define CSR_APF_VIDEO_VSYNC_STATUS_ADDR (CSR_BASE + 0x2800L)
#define CSR_APF_VIDEO_VSYNC_STATUS_SIZE 1
static inline uint32_t apf_video_vsync_status_read(void) {
	return csr_read_simple((CSR_BASE + 0x2800L));
}
#define CSR_APF_VIDEO_VBLANK_STATUS_ADDR (CSR_BASE + 0x2804L)
#define CSR_APF_VIDEO_VBLANK_STATUS_SIZE 1
static inline uint32_t apf_video_vblank_status_read(void) {
	return csr_read_simple((CSR_BASE + 0x2804L));
}
#define CSR_APF_VIDEO_FRAME_COUNTER_ADDR (CSR_BASE + 0x2808L)
#define CSR_APF_VIDEO_FRAME_COUNTER_SIZE 1
static inline uint32_t apf_video_frame_counter_read(void) {
...
#define CSR_TIMER0_UPTIME_LATCH_ADDR (CSR_BASE + 0x4820L)
...
#define CSR_TIMER0_UPTIME_CYCLES_ADDR (CSR_BASE + 0x4824L)
#define CSR_TIMER0_UPTIME_CYCLES_SIZE 2
static inline uint64_t timer0_uptime_cycles_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0x4824L));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0x4828L));
	return r;
}
...
/* video_framebuffer */
#define CSR_VIDEO_FRAMEBUFFER_BASE (CSR_BASE + 0x5800L)
#define CSR_VIDEO_FRAMEBUFFER_DMA_BASE_ADDR (CSR_BASE + 0x5800L)
...
#define CSR_VIDEO_FRAMEBUFFER_DMA_LENGTH_ADDR (CSR_BASE + 0x5804L)
...
#define CSR_VIDEO_FRAMEBUFFER_DMA_ENABLE_ADDR (CSR_BASE + 0x5808L)
...
#define CSR_VIDEO_FRAMEBUFFER_DMA_DONE_ADDR (CSR_BASE + 0x580cL)
...
#define CSR_VIDEO_FRAMEBUFFER_DMA_LOOP_ADDR (CSR_BASE + 0x5810L)
...
#define CSR_VIDEO_FRAMEBUFFER_DMA_OFFSET_ADDR (CSR_BASE + 0x5814L)
...
#define CSR_VIDEO_FRAMEBUFFER_VTG_BASE (CSR_BASE + 0x6000L)
#define CSR_VIDEO_FRAMEBUFFER_VTG_ENABLE_ADDR (CSR_BASE + 0x6000L)
...
#define CSR_VIDEO_FRAMEBUFFER_VTG_HRES_ADDR (CSR_BASE + 0x6004L)
...
#define CSR_VIDEO_FRAMEBUFFER_VTG_HSYNC_START_ADDR (CSR_BASE + 0x6008L)
...
#define CSR_VIDEO_FRAMEBUFFER_VTG_HSYNC_END_ADDR (CSR_BASE + 0x600cL)
...
#define CSR_VIDEO_FRAMEBUFFER_VTG_HSCAN_ADDR (CSR_BASE + 0x6010L)
...
#define CSR_VIDEO_FRAMEBUFFER_VTG_VRES_ADDR (CSR_BASE + 0x6014L)
...
#define CSR_VIDEO_FRAMEBUFFER_VTG_VSYNC_START_ADDR (CSR_BASE + 0x6018L)
...
#define CSR_VIDEO_FRAMEBUFFER_VTG_VSYNC_END_ADDR (CSR_BASE + 0x601cL)
...
#define CSR_VIDEO_FRAMEBUFFER_VTG_VSCAN_ADDR (CSR_BASE + 0x6020L)
