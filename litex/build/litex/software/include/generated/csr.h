...
#define CSR_APF_BRIDGE_SCALER_SLOT_ADDR (CSR_BASE + 0x830L)
#define CSR_APF_BRIDGE_SCALER_SLOT_SIZE 1
static inline uint32_t apf_bridge_scaler_slot_read(void) {
	return csr_read_simple((CSR_BASE + 0x830L));
}
static inline void apf_bridge_scaler_slot_write(uint32_t v) {
