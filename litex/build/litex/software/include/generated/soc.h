...
#define DEPLOYMENT_PLATFORM "openfpga"
#define DEPLOYMENT_TARGET "pocket"
...
static inline const char * deployment_platform_read(void) {
	return "openfpga";
}
static inline const char * deployment_target_read(void) {
	return "pocket";
}
...
static inline int max_display_width_read(void) {
	return 266;
}
static inline int max_display_height_read(void) {
	return 240;
}
