...
pub const CONFIG_CPU_ISA: &[u8; 15usize] = b"rv32i2p0_mafdc\0";
pub const CONFIG_CPU_MMU: &[u8; 5usize] = b"sv32\0";
...
pub const CONFIG_CPU_HUMAN_NAME: &[u8; 22usize] = b"VexRiscv SMP-STANDARD\0";
pub const CONFIG_CPU_NOP: &[u8; 4usize] = b"nop\0";
pub const DEPLOYMENT_PLATFORM: &[u8; 9usize] = b"openfpga\0";
pub const DEPLOYMENT_TARGET: &[u8; 7usize] = b"pocket\0";
...
pub const CONFIG_BUS_STANDARD: &[u8; 9usize] = b"WISHBONE\0";
