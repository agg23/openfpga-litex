...
pub command_result_code : COMMAND_RESULT_CODE , # [doc = "0x30 - The index in video.json of the current scaler mode. Set during VBLANK."]
...
impl crate :: Resettable for COMMAND_RESULT_CODE_SPEC { const RESET_VALUE : Self :: Ux = 0 ; } } # [doc = "SCALER_SLOT (rw) register accessor: The index in video.json of the current scaler mode. Set during VBLANK.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`scaler_slot::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`scaler_slot::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@scaler_slot`]
module"]
pub type SCALER_SLOT = crate :: Reg < scaler_slot :: SCALER_SLOT_SPEC > ; # [doc = "The index in video.json of the current scaler mode. Set during VBLANK."]
...
pub type SCALER_SLOT_W < 'a , REG , const O : u8 > = crate :: FieldWriter < 'a , REG , 3 , O > ; impl R { # [doc = "Bits 0:2"]
# [inline (always)]
pub fn scaler_slot (& self) -> SCALER_SLOT_R { SCALER_SLOT_R :: new ((self . bits & 7) as u8) } } impl W { # [doc = "Bits 0:2"]
# [inline (always)]
# [must_use]
...
# [doc = r" Passing incorrect value can cause undefined behaviour. See reference manual"]
# [inline (always)]
pub unsafe fn bits (& mut self , bits : u32) -> & mut Self { self . bits = bits ; self } } # [doc = "The index in video.json of the current scaler mode. Set during VBLANK.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`scaler_slot::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`scaler_slot::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
