...
pub bridge_request_read : BRIDGE_REQUEST_READ , # [doc = "0x08 - "]
pub bridge_slot_id : BRIDGE_SLOT_ID , # [doc = "0x0c - "]
pub bridge_data_offset : BRIDGE_DATA_OFFSET , # [doc = "0x10 - "]
pub bridge_length : BRIDGE_LENGTH , # [doc = "0x14 - "]
pub ram_data_address : RAM_DATA_ADDRESS , # [doc = "0x18 - "]
pub bridge_file_size : BRIDGE_FILE_SIZE , # [doc = "0x1c - "]
pub bridge_status : BRIDGE_STATUS , # [doc = "0x20 - "]
pub bridge_current_address : BRIDGE_CURRENT_ADDRESS , # [doc = "0x24 - "]
pub audio_out : AUDIO_OUT , # [doc = "0x28 - "]
pub audio_playback_en : AUDIO_PLAYBACK_EN , # [doc = "0x2c - "]
pub audio_buffer_fill : AUDIO_BUFFER_FILL , } # [doc = "CONT1_KEY (rw) register accessor: \n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cont1_key::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cont1_key::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`cont1_key`]
module"]
...
impl crate :: Resettable for AUDIO_BUFFER_FILL_SPEC { const RESET_VALUE : Self :: Ux = 0 ; } } } # [doc = "SDRAM"]
...
impl crate :: Writable for DMA_LENGTH_SPEC { const ZERO_TO_MODIFY_FIELDS_BITMAP : Self :: Ux = 0 ; const ONE_TO_MODIFY_FIELDS_BITMAP : Self :: Ux = 0 ; } # [doc = "`reset()` method sets DMA_LENGTH to value 0x0001_f400"]
impl crate :: Resettable for DMA_LENGTH_SPEC { const RESET_VALUE : Self :: Ux = 0x0001_f400 ; } } # [doc = "DMA_ENABLE (rw) register accessor: \n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dma_enable::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`dma_enable::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`dma_enable`]
module"]
